...
install_server_automatic() {
    ...
    # Iran-hardened defaults — stronger padding/jitter for advanced DPI
    PROFILE="speed"
    VERBOSE="true"
    SMUX_KEEPALIVE=2; SMUX_MAXRECV=2097152; SMUX_MAXSTREAM=2097152; SMUX_FRAMESIZE=8192
    TCP_NODELAY="true"; TCP_KEEPALIVE=5; TCP_READBUFFER=131072; TCP_WRITEBUFFER=131072
    MAX_CONNECTIONS=500; MAX_STREAMS=512
    OBFS_ENABLED="true"; OBFS_MIN_PAD=32; OBFS_MAX_PAD=128; OBFS_MIN_DELAY=0; OBFS_MAX_DELAY=0
